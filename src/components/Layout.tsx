      ...
      <aside className={cn(
        ...
        {!isSidebarCollapsed ? (
          <div className="pb-4 pt-0 flex flex-col items-center justify-center text-center bg-slate-50/50 dark:bg-slate-900/40 rounded-b-2xl animate-in fade-in duration-200">
            ...
            <span className="text-[10px] font-semibold text-slate-400 dark:text-slate-500 mt-1">v2.4.5 (07/09)</span>
          </div>
        ) : (
          <div className="pb-3 pt-1 flex flex-col items-center justify-center text-center bg-slate-50/50 dark:bg-slate-900/40 rounded-b-2xl">
            <a href="https://www.lnx.com.ar" target="_blank" rel="noopener noreferrer" title="Desarrollado por LYNX - v2.4.5" className="group cursor-pointer">
            ...
            <span className="text-[8px] font-semibold text-slate-400 dark:text-slate-500 mt-0.5">v2.4.5</span>
          </div>
        )}
      </aside>
