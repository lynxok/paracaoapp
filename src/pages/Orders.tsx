...
export function Orders() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
      <Link to="/orders/new/monofocal" className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:border-blue-500/50 transition-all group flex flex-col items-center text-center gap-4">
      ...
      <Link to="/orders/new/multifocal" className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:border-indigo-500/50 transition-all group flex flex-col items-center text-center gap-4">
      ...
      <Link to="/orders/new/ocupacional" className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:border-violet-500/50 transition-all group flex flex-col items-center text-center gap-4">
      ...
      <Link to="/orders/new/contact" className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:border-emerald-500/50 transition-all group flex flex-col items-center text-center gap-4">
